...
#I created this project in my junior year of high school for my final project
#in my first programming class. It remains to be my favorite project I've done
#so far because it is adorable and I had a lot of fun creating it.
#Although I'll admit, there would be things I would change if I were to make
#this project today. For example, I really wish I would have commented
#my code better. In addition, in high school we were taught to import
#everything; however, now I know that that is bad practice and only what you
#need should be imported. 
